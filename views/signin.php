...
<body style="background-image: url(../image/h7-slide6.jpg);">
    ...
    <div class="login-area">
        ...
        <div class="logo">
            <img src="../image/Quick Tickets logo.png" alt="logo-image">
        </div>
        <div>
            <h1 style="text-align: center; color: #ffffff; font: normal 80px 'Cookie', cursive;">Quick<span style=" color: #e0ac1c;">Tickets</span></h1>
        ...
        <div class="form-area">
            <form action="" method="post" class="sign-in-form">
                ...
                <div class="part headericon">
                    <p style="color: white"> don't have an account</p><br>
